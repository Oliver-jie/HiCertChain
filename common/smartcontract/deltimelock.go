...
// Creatdelhashtimelock adds a new cert   input 12 and output 1
func (s *SmartContract) Creatdelhashtimelock(ctx contractapi.TransactionContextInterface,id string,certId string,hash string,nowtime string,endtime string,randomString string,publicKey string,optionalString string) error {
...
func (s *SmartContract) ExedelTimeHashlock(ctx contractapi.TransactionContextInterface,id string,certId string,hash string,nowtime string,endtime string,randomString string,publicKey string,optionalString string) error {
	hashtime_lock :=Hashtime_lock{
		Id : id,
		CertId : certId,
		Hash : hash,
...
func (s *SmartContract) QuerydelTimeHashlock(ctx contractapi.TransactionContextInterface,id string) (*Hashtime_lock, error) {
