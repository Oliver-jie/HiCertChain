	...
	for _, testCase := range []struct {
		...
		},
		{
			...
			mutateBlockSequence: func(blockSequence []*common.Block) []*common.Block {
				...
				blockSequence[len(blockSequence)/2].Header.DataHash = protoutil.BlockDataHash(blockSequence[len(blockSequence)/2].Data,blockSequence[len(blockSequence)/2].Header.Number)
				assignHashes(blockSequence)
				return blockSequence
			},
		...
		},
		{
			...
			mutateBlockSequence: func(blockSequence []*common.Block) []*common.Block {
				...
				blockSequence[len(blockSequence)/4].Header.DataHash = protoutil.BlockDataHash(blockSequence[len(blockSequence)/4].Data,blockSequence[len(blockSequence)/4].Header.Number)
		...
		},
		{
			...
			mutateBlockSequence: func(blockSequence []*common.Block) []*common.Block {
				...
				blockSequence[len(blockSequence)-1].Header.DataHash = protoutil.BlockDataHash(blockSequence[len(blockSequence)-1].Data,blockSequence[len(blockSequence)-1].Header.Number)
...
func createBlockChain(start, end uint64) []*common.Block {
	...
	for seq := uint64(start); seq <= uint64(end); seq++ {
		...
		block.Header.DataHash = protoutil.BlockDataHash(block.Data,block.Header.Number)
