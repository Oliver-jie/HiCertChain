...
func TestCreateNextBlock(t *testing.T) {
	...
	assert.Equal(t, protoutil.BlockDataHash(second.Data,second.Header.Number), second.Header.DataHash)
	...
	assert.Equal(t, protoutil.BlockDataHash(third.Data,second.Header.Number), third.Header.DataHash)
