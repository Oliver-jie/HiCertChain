...
func main () {
	...
	insert_time := 0
	//表1的结构
	var table1 [8192][4]string
	//表一的附属表
	var table1_num [8192]int
	//表2的结构
	var table2 [8192][4]string
	//表2附属表
	var table2_num [8192]int
	//第n次的插入
	time1 := 0
...
func compu_chart(cert1String string,num int)string{
	...
	// 转换成十进制
	chart:=Hex2Dec2(cert3String)%8192
	// 指纹信息
