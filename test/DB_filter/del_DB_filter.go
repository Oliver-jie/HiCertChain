...
func main () {
	...
	//证书插入 95-124459-62259-62200  90-121239-58982-58980 85-117959-55705-55700
	//开始装填证书信息
	start := time.Now()
	for i:=0;i<=117959;i++ {
        // 开始记时
		...
		if i==55700 {
			getchart:=RandInt(10)
			high := RandInt(table_high)
			breadth :=RandInt(table_bread)
			if getchart%2==0 {
				for table1[high][breadth] =="" {
					high = RandInt(table_high)
					breadth =RandInt(table_bread)
				}
				table1[high][breadth] =""
